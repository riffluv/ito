...
export default function UniversalMonitor({
  ...
  return (
    <Box textAlign="center" marginBottom={{ base: "0.75rem", md: "1.0rem" }} css={{ [`@media ${UNIFIED_LAYOUT.MEDIA_QUERIES.DPI_125}`]: { marginBottom: "0.375rem" } }}>
      <Centered px={3}>
        ...
        <Box
          ...
          css={{ [`@media ${UNIFIED_LAYOUT.MEDIA_QUERIES.DPI_125}`]: { padding: "1rem", marginBottom: "0.5rem" } }}
        >
          <Box
            fontSize="0.875rem"
            opacity={0.8}
