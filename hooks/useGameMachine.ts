...
import { gameMachine, gameSelectors, type GameContext, type GameEvent } from '@/lib/state/gameMachine';
...
export function useGameMachine() {
  ...
  const selectors = {
    ...
    getEffectivePlayerCount: () => gameSelectors.getEffectivePlayerCount(context),
