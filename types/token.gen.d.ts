export type Token =
  ...
  | "borders.xl"
  | "borders.retrogame"
  | "borders.retrogameInput"
  | "borders.retrogameThin"
  | "borders.retrogameGame"
  | "borders.retrogameAccent"
  | "borders.retrogameBevel"
  | "colors.transparent"
  | "colors.current"
  | "colors.black"
  | "colors.white"
  ...
  | "colors.obsidian.950"
  | "colors.slimeBlue.50"
  | "colors.slimeBlue.100"
  | "colors.slimeBlue.200"
  | "colors.slimeBlue.300"
  | "colors.slimeBlue.400"
  | "colors.slimeBlue.500"
  | "colors.slimeBlue.600"
  | "colors.slimeBlue.700"
  | "colors.slimeBlue.800"
  | "colors.slimeBlue.900"
  | "colors.heroGold.50"
  | "colors.heroGold.100"
  | "colors.heroGold.200"
  | "colors.heroGold.300"
  ...
  | "colors.richBlack.200"
  | "colors.richBlack.300"
  | "colors.richBlack.400"
  | "colors.richBlack.500"
  | "colors.richBlack.600"
  | "colors.richBlack.700"
  | "colors.richBlack.800"
  | "colors.richBlack.900"
  | "colors.richBlack.950"
  | "colors.success.50"
  | "colors.success.400"
  | "colors.success.500"
  | "colors.success.600"
  ...
  | "shadows.cardHover"
  | "shadows.panel"
  | "shadows.cardHandActive"
  | "shadows.cardHandInactive"
  | "shadows.cardHandHover"
  | "breakpoints.sm"
  | "breakpoints.md"
  | "breakpoints.lg"
  | "breakpoints.xl"
  ...
  | "colors.cardHand"
  | "colors.cardHandDisabled"
  | "colors.cardHandBorder"
  | "colors.cardHandBorderDisabled"
  | "colors.cardHandBorderHover"
  | "colors.cardHandText"
  | "colors.cardHandTextDisabled"
  | "colors.cardHandHover"
  | "colors.cardCentralWaitingBg"
  | "colors.cardCentralWaitingBorder"
  | "colors.cardCentralWaitingText"
  | "colors.cardCentralWaitingNumber"
  | "colors.cardCentralWaitingMeta"
  | "colors.successLegacy"
  | "colors.warning"
  | "colors.dangerLegacy"
  ...
  | "colors.glassBg08"
  | "colors.glassBorder"
  | "colors.glassBorderWeak"
  | "colors.brandGradient"
  | "colors.brandGradientHover"
  | "colors.brandShadow"
  | "colors.brandShadowHover"
  | "colors.brandRing"
  | "colors.panelBannerFg"
  | "colors.selfNumberFg"
  | "shadows.inner"
  | "shadows.inset"
  | "radii.l1"
...
export type LineHeightsToken = "shorter" | "short" | "moderate" | "tall" | "taller" | "tight" | "snug" | "normal" | "relaxed" | "loose"
